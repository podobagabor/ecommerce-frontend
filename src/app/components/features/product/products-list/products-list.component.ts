...
export class ProductsListComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.basicFilterForm.controls.minPrice.valueChanges.pipe(
    ...
    this.basicFilterForm.controls.maxPrice.valueChanges.pipe(
      takeUntil(this.unsubscribe$),
    ).subscribe((value) => {
      if (value !== null) {
    ...
    this.basicFilterForm.controls.discount.valueChanges.pipe(
      takeUntil(this.unsubscribe$),
    ).subscribe((value) => {
      if (value !== null) {
